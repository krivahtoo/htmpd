...
<div class="pt-2">
  <div class="flex w-full mt-5 mx-5">
    ...
    <div class="flex justify-end ml-auto mr-6 my-auto">
      <a href="https://github.com/krivahtoo/htmpd">
    ...
    <div class="flex justify-end ml-1 mr-10 my-auto">
      <button on:click={ () => dispatcher('settings') }>
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="gears" class="w-6 h-6" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
